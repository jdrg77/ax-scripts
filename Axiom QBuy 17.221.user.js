...
(function () {
  ...
  function getOrCreateBadge(newBtn) {
    ...
    if (!badge) {
      ...
      badge.style.cssText = 'position:absolute;left:-56px;top:-18px;font-size:6px;font-weight:700;font-family:monospace;color:#fff;border-radius:4px;pointer-events:none;white-space:nowrap;border:1px solid currentColor;z-index:10001;transition:color 0.3s;';
  ...
  function renderGradProxies() {
    ...
    gradCandidates.filter(t => !t.ca || !normalMemeIds.has(t.ca)).slice(0, 3).forEach((token, i) => {
      ...
      badge.style.cssText = `position:absolute;left:-56px;top:-18px;font-size:6px;font-weight:700;font-family:monospace;color:${col};border-radius:4px;pointer-events:none;white-space:nowrap;border:1px solid ${col};z-index:10001;`;
