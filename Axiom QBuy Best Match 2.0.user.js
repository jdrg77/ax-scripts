// ==UserScript==
// @name         Axiom QBuy Best Match 2.0
...
(function () {
  ...
  function updateMiniButtons() {
    ...
    rows.forEach((row, rowIdx) => {
      ...
      // Only block new entries at row 0 while waiting for grad scan — existing entries always show
  ...
  console.log('⭐ Axiom QBuy Best Match 2.0 v1.0');
})();
